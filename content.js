...
const HandbuchHTML = `
    <div class="mb-6">
        <h2 class="text-2xl font-black text-slate-800">Bedienungsanleitung & Logik</h2>
        <p class="text-sm text-slate-500 mt-1">Wie die App rechnet und wie du sie optimal nutzt.</p>
    </div>
    
    <h3 class="text-lg font-bold text-slate-800 mt-8 mb-2 border-b border-slate-200 pb-2">Teil A: Bedienungsanleitung (How-To)</h3>

    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <button onclick="toggleAcc('acc_ht1')" class="w-full p-5 text-left font-bold text-slate-800 flex justify-between bg-slate-50 hover:bg-slate-100 transition-colors"><span>Schritt 1: Standort & Strings einrichten</span><span class="text-slate-400">▼</span></button>
        <div id="acc_ht1" class="acc-content px-5 pb-5 text-sm text-slate-600 border-t border-slate-100">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <button onclick="toggleAcc('acc_ht2')" class="w-full p-5 text-left font-bold text-slate-800 flex justify-between bg-slate-50 hover:bg-slate-100 transition-colors"><span>Schritt 2: Verbrauch & Smart-Home</span><span class="text-slate-400">▼</span></button>
        <div id="acc_ht2" class="acc-content px-5 pb-5 text-sm text-slate-600 border-t border-slate-100">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <button onclick="toggleAcc('acc_ht3')" class="w-full p-5 text-left font-bold text-slate-800 flex justify-between bg-slate-50 hover:bg-slate-100 transition-colors"><span>Schritt 3: Kosten & Substitution</span><span class="text-slate-400">▼</span></button>
        <div id="acc_ht3" class="acc-content px-5 pb-5 text-sm text-slate-600 border-t border-slate-100">
    ...
    <h3 class="text-lg font-bold text-slate-800 mt-10 mb-2 border-b border-slate-200 pb-2">Teil B: Hintergrund-Prozesse (Die Engine)</h3>

    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <button onclick="toggleAcc('acc_bg1')" class="w-full p-5 text-left font-bold text-slate-800 flex justify-between bg-slate-50 hover:bg-slate-100 transition-colors"><span>Farblogik der Strings (Modul-Physik)</span><span class="text-slate-400">▼</span></button>
        <div id="acc_bg1" class="acc-content px-5 pb-5 text-sm text-slate-600 border-t border-slate-100">
            <p class="mt-4">In der String-Übersicht siehst du die Parameter deines Strings als kleinen Code. Die App prüft die Spannungen physikalisch gegen die Limits deines Wechselrichters:</p>
            <ul class="list-disc pl-5 mt-2 space-y-2">
                ...
                <li><strong class="text-rose-500">Rot (Gefahr/Fehler):</strong> Die Voc (Leerlaufspannung bei -20°C im Winter) ist höher als die Maximalspannung des WR (Zerstörungsgefahr!), der Strom ist zu hoch, oder die Vmp ist so niedrig, dass der WR nicht anspringt.</li>
            </ul>
        </div>
    </div>

    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <button onclick="toggleAcc('acc_bg_mismatch')" class="w-full p-5 text-left font-bold text-slate-800 flex justify-between bg-slate-50 hover:bg-slate-100 transition-colors"><span>Die stundengenaue Mismatch-Berechnung</span><span class="text-slate-400">▼</span></button>
        <div id="acc_bg_mismatch" class="acc-content px-5 pb-5 text-sm text-slate-600 border-t border-slate-100">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <button onclick="toggleAcc('acc_bg2')" class="w-full p-5 text-left font-bold text-slate-800 flex justify-between bg-slate-50 hover:bg-slate-100 transition-colors"><span>Die 8760-Stunden-Matrix & AC-Clipping</span><span class="text-slate-400">▼</span></button>
        <div id="acc_bg2" class="acc-content px-5 pb-5 text-sm text-slate-600 border-t border-slate-100">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <button onclick="toggleAcc('acc_bg3')" class="w-full p-5 text-left font-bold text-slate-800 flex justify-between bg-slate-50 hover:bg-slate-100 transition-colors"><span>Finanzen: EEG-Degression & Öl/Gas Umrechnung</span><span class="text-slate-400">▼</span></button>
        <div id="acc_bg3" class="acc-content px-5 pb-5 text-sm text-slate-600 border-t border-slate-100">
